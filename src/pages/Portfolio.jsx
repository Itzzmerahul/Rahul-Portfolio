...
export default function Portfolio() {
  ...
  className="flex flex-col items-center justify-between p-4 shadow-xl rounded-lg shadow-gray-300 dark:shadow-gray-600 bg-white dark:bg-gray-800 border border-black dark:border-white gap-10 lg:flex-row lg:p-2 text-md text-black"
>
            <div className="rounded-lg  h-full px-2 " >
              <div className="lg:m-4 m-1  text-xl lg:text-2xl  dark:text-white text-gray-800 Portfolio1-font">My Overview</div>
              <div  className='dark:text-white text-gray-800 quick bg-white dark:bg-gray-800 p-4 text-lg' id='quick' >
